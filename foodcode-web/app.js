...
app.get('/termsofeating', function(req, res){
	res.sendfile('public/termsofeating.html');
});
app.get('/unprivacypolicy', function(req, res){
	res.sendfile('public/unprivacypolicy.html');
});
