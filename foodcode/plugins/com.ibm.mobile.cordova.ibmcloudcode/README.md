Mobile Cloud Services Cloud Code Cordova SDK for IBM Bluemix
===
...
The Mobile Cloud Services IBMCloudCode SDK is a Cordova SDK you can use inside a Cordova
or IBM Worklight application. The `IBMCloudCode` SDK manages all the invocation
...
```bash
cordova plugin remove com.ibm.mobile.cordova.ibmcloudcode
```
